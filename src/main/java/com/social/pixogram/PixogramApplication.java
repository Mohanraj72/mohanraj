...
public class PixogramApplication implements CommandLineRunner {
	...
	ApplicationRunner init(UserRepository userRepo) {
		return args -> {
			Stream.of(new User("Mohan", "mohan@gmail.com", "smlu"), new User("monish", "monish@gmail.com", "root"),
					new User("raj", "raj@gmail.com", "root"), new User("karupu", "karupu@gmail.com", "root"),
					new User("suren", "suren@gmail.com", "root"), new User("mahesh", "mahesh@gmail.com", "root"),
					new User("users", "users@gmail.com", "root"), new User("ajay", "ajay@gmail.com", "root"),
					new User("tharun", "tharun@gmail.com", "root"), new User("lavanya", "lavanya@gmail.com", "root"))
					.forEach(user -> {
						userRepo.save(user);
					});
	...
	ApplicationRunner init1(MediaRepository mediaRepository, StorageService storageService) {
		return args -> {
			Stream.of(new Media(1, "dummy1.jpg", 12, 45, 8), new Media(1, "dummy2.jpg", 12, 56, 7),
					new Media(2, "dummy3.jpg", 12, 1, 19), new Media(2, "dummy4.jpg", 12, 12, 0),
					...
					new Media(5, "dummy9.jpg", 12, 23, 56), new Media(5, "dummy10.jpg", 12, 45, 56),
